  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-presentation text-text-primary">
      ...
      <BlinkAnimation active={isFetching}>
        <div className="mt-6 h-10 w-full bg-cover">
          <BrandLockup
            ...
            alt={localize('com_ui_logo', { 0: startupConfig?.appTitle ?? APP_NAME })}
          />
        </div>
      </BlinkAnimation>
      <DisplayError />
      ...
      <main className="flex flex-grow items-center justify-center">
        <div className="w-authPageWidth overflow-hidden bg-presentation px-6 py-4 sm:max-w-md sm:rounded-lg">
